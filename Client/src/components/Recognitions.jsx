...
const technologies = [
	{
		name: 'MCA',
		image: 'images/Ministry_of_Corporate_Affairs_India.svg',
				...
				<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6">
					{technologies.map((tech, index) => (
						...
						>
							...
							>
								{/* Front Side */}
								<div className="bg-white absolute w-full h-full backface-hidden bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl shadow-md flex items-center justify-center p-6">
