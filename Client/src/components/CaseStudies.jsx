		...
		<section className="py-20 px-4 md:py-28" style={{ background: 'var(--background)' }}>
			<div className="w-[90%] mx-auto">
				...
				<div className="text-center mb-16">
					...
					<p
						className="max-w-xl mx-auto text-base mt-2"
