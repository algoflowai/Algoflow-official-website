		...
		>
			...
			<div className="w-[90%] mx-auto relative z-10">
				...
				>
					...
					>
						From India's national digital missions to the UAE's smart city projects, UK
						enterprises, and Silicon Valley startups — AlgoFlow AI delivers across
						borders, time zones, and industries.
					</p>
				</motion.div>
				...
				>
					{STATS.map((s) => (
						...
						>
							<div className="text-2xl sm:text-3xl font-extrabold text-green-500 mb-1">
								{s.value}
							</div>
							<div
