...
const ContactPopup = ({ onClose }) => {
	...
	return (
		<>
			...
			<div
				className="fixed inset-0 mt-20 flex justify-center items-center z-50 font-Inter p-4"
				style={{ background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(4px)' }}
			>
				<div
					className="rounded-2xl shadow-2xl p-6 max-w-lg w-full text-center relative max-h-[90vh] overflow-y-auto"
					style={{
						background: dark ? 'rgba(6,13,27,0.98)' : '#ffffff',
						border: dark ? '1px solid rgba(34,197,94,0.2)' : '1px solid #e5e7eb',
						boxShadow: dark
							? '0 24px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(34,197,94,0.1)'
				...
				>
					<button
						...
						onMouseEnter={(e) =>
							(e.currentTarget.style.color = dark ? '#94a3b8' : '#111827')
						}
						onMouseLeave={(e) =>
							(e.currentTarget.style.color = dark ? '#64748b' : '#6b7280')
						}
						onClick={onClose}
					>
						&times;
