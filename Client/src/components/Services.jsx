		...
		<section className="relative py-24 px-4 md:px-6 dark-section overflow-hidden">
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				...
				<motion.div
					...
					style={{
						background:
							'radial-gradient(circle, rgba(61,99,234,0.07) 0%, transparent 70%)',
					}}
					...
					{services.map((service, index) => (
						<motion.div
							...
							whileHover={{
								y: -8,
								boxShadow:
									'0 0 40px rgba(34,197,94,0.15), 0 20px 60px rgba(0,0,0,0.4)',
							}}
						>
							{/* Number badge */}
							...
							<div className="relative z-10">
								...
								{/* Content */}
								<div className="p-6">
									<motion.h3 className="mb-3 text-lg font-bold text-white group-hover:text-green-400 transition-colors duration-300">
										{service.title}
									</motion.h3>
