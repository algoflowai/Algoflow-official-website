		...
		>
			...
			>
				...
				<p className="text-[var(--text-secondary)] mt-2 text-sm max-w-md mx-auto">
					Enterprise-grade security and compliance baked into every stage — built for
					fintech, banking, healthcare, and high-stakes industries.
				</p>
			</motion.div>
			<motion.div
					...
					{steps.map((step, index) => (
						...
						>
							...
							<motion.div
								...
								whileHover={{
									boxShadow:
										'0 0 30px rgba(34,197,94,0.12), 0 10px 40px rgba(0,0,0,0.08)',
									borderColor: '#22c55e',
								}}
							>
								<div>
