	...
	return (
		<>
			...
			<section
				...
				style={{
					background:
						'linear-gradient(135deg,#020b14 0%,#040f1e 40%,#050d1a 70%,#020b14 100%)',
					paddingTop: '82px',
				}}
			>
					...
					>
						...
						{NODES.map((n, i) => (
							<motion.circle
								...
								animate={{
									r: i === pulse ? [0.55, 1.1, 0.55] : 0.55,
									opacity: i === pulse ? [1, 0.5, 1] : 0.35,
								}}
				...
				<div className="relative z-10 w-[90%] mx-auto py-16 lg:py-24">
					<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
						...
						>
							...
							>
								We engineer production-grade AI — from{' '}
								<strong className="text-white">computer vision</strong> and{' '}
								<strong className="text-white">LLMs</strong> to{' '}
								<strong className="text-white">agentic workflows</strong> —
								delivering measurable impact for fintech, healthcare, manufacturing,
								and beyond.
							</motion.p>
							...
							>
								<motion.button
									...
									whileHover={{
										scale: 1.04,
										boxShadow: '0 0 48px rgba(34,197,94,0.5)',
									}}
									whileTap={{ scale: 0.97 }}
								>
									<svg
								...
								<Link href="/projects">
									<motion.div
										className="flex items-center gap-2 px-7 py-3.5 rounded-xl text-base font-semibold border cursor-pointer"
										style={{
							...
							{CARDS.map((c, i) => (
								<Link href={c.href} key={c.title}>
									<motion.div
										...
										whileHover={{
											background: `rgba(${c.col},0.08)`,
											borderColor: `rgba(${c.col},0.3)`,
											y: -3,
										}}
									>
					...
					{/* Stats bar */}
					<motion.div
						className="mt-16 lg:mt-20 grid grid-cols-2 sm:grid-cols-4 gap-6 pt-10 border-t"
