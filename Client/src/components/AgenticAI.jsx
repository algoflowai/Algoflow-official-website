...
const domains = [
	...
	},
	{
		...
		capabilities: [
			'Multi-airline Search & Compare',
			'Auto Itinerary Management',
...
export default function AgenticAI() {
	...
	return (
		...
		>
			...
			{/* Ambient glow orbs */}
			<div
				className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full opacity-10 blur-[120px] pointer-events-none"
			...
			<div className="relative z-10 w-[90%] mx-auto">
				...
				>
					...
					<p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
						We build autonomous AI agents that{' '}
						<span className="text-green-400 font-medium">
							perceive, reason, act, and learn
						</span>{' '}
						— operating across industries with superhuman speed and precision.
					</p>
				</motion.div>
				...
				>
					...
					<div className="relative flex flex-col md:flex-row items-stretch gap-0">
						...
						<div
							className="hidden md:block absolute top-[44px] left-[10%] right-[10%] h-[2px]"
							style={{
								background:
									'linear-gradient(90deg, rgba(34,197,94,0) 0%, rgba(34,197,94,0.5) 20%, rgba(34,197,94,0.5) 80%, rgba(34,197,94,0) 100%)',
							}}
						/>
						...
						{workflowSteps.map((step, i) => (
							...
							>
								...
								>
									<div
										className={`bg-gradient-to-br ${step.color} rounded-full p-2 mb-1 text-white`}
									>
										{step.icon}
									</div>
								...
								{i < workflowSteps.length - 1 && (
									<div className="md:hidden flex justify-center my-1">
										<svg
											className="w-4 h-4 text-green-500 rotate-90"
											fill="none"
											stroke="currentColor"
											viewBox="0 0 24 24"
										>
								...
								<p className="text-gray-400 text-xs leading-relaxed max-w-[160px]">
									{step.desc}
								</p>
