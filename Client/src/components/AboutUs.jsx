		...
		<>
			...
			>
				<div className="md:w-[535px] md:h-[420px] mb-8 md:mb-0 flex gap-8 flex-col">
					...
					>
						At Algoflow AI, we are passionate about creating intelligent solutions that
						help businesses thrive in an increasingly digital world. With a strong
						foundation in AI services, software development, and consulting, we
						specialize in crafting innovative, scalable products designed to address
				...
				>
					<div className="md:w-[601px] md:h-[460px] flex items-center justify-center relative">
						...
						<div
							...
							style={{
								boxShadow:
									'inset 0 0 0 1px rgba(34,197,94,0.15), 0 20px 60px rgba(0,0,0,0.08)',
							}}
						/>
						<motion.div
						...
						>
							<div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
								<div className="w-16 h-16 bg-white/30 rounded-full flex items-center justify-center">
									<motion.div className="w-12 h-12 bg-gradient-to-br from-[#22c55e] to-[#16a34a] rounded-full flex items-center justify-center pulse-glow-anim">
										<svg
											width="24"
											height="24"
											viewBox="0 0 24 24"
				...
				<div className="w-[90%] mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
					{stats.map((stat, i) => (
						<motion.div
							...
							whileHover={{ y: -4 }}
						>
							<div className="text-3xl md:text-4xl font-extrabold gradient-text leading-tight">
								{stat.value}
							</div>
