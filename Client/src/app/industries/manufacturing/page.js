		...
		<div style={{ background: '#020b14', minHeight: '100vh' }}>
				...
				<div className="w-[90%] mx-auto py-24 lg:py-32 relative z-10">
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							>
								From smart factories to fully autonomous dark factories — we bring
								AI-driven quality control, predictive maintenance, and intelligent
								production to manufacturing and energy industries.
							</motion.p>
							<motion.div
			...
			<section className="w-[90%] mx-auto py-20">
				...
				>
					...
					<p className="text-gray-400 mt-3 max-w-2xl">
						A production environment where machines, data, and intelligence work
						seamlessly together — increasing output, reducing waste, and improving
			...
			>
				<div className="w-[90%] mx-auto py-20">
					...
					>
						...
						<p className="text-gray-400 mt-3 max-w-2xl">
							A fully autonomous, lights-off production facility where AI runs every
							process — from intake to dispatch — with zero human operators on the
							floor.
						</p>
					</motion.div>
					...
					>
						<p className="text-sm text-gray-300 max-w-2xl mx-auto">
							<span className="font-bold text-white">The Dark Factory</span>{' '}
							represents the future of manufacturing — a self-operating, self-healing
							production system where AI handles everything from supply chain signals
							to finished goods, 24/7, without breaks.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="w-[90%] mx-auto py-20">
				...
				>
					...
					<h2 className="text-3xl sm:text-4xl font-extrabold text-white">
						AI for Oil & Gas Operations
					</h2>
					<p className="text-gray-400 mt-3 max-w-2xl">
						Production optimization, pipeline safety, regulatory compliance, and
						operational intelligence — built for the unique demands of upstream,
				...
				<div className="w-[90%] mx-auto py-20">
					...
					>
						...
						<p className="text-gray-400 mt-3">
							Delivered for India's top industrial enterprises.
						</p>
					</motion.div>
					<div className="grid md:grid-cols-2 gap-6">
						{CASE_STUDIES.map((cs, i) => (
							...
							>
								...
								<div
									className="text-xl font-extrabold text-transparent bg-clip-text mb-3"
									style={{
			...
			<section className="w-[90%] mx-auto py-20">
				...
				>
					...
					<p className="text-gray-400 mt-3">
						Proven industrial-grade tools for OT/IT convergence.
					</p>
				</motion.div>
				<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
					{TECH_STACK.map((t, i) => (
			...
			<section className="max-w-4xl mx-auto px-6 py-24 text-center">
				...
				>
					...
					<p className="text-gray-400 mb-8 max-w-xl mx-auto">
						Whether you're building your first smart factory or moving towards a fully
						autonomous dark factory — our engineers have done it before, at scale.
					</p>
