export const metadata = {
	...
	description:
		'Clinical AI, ABDM/ABHA integration, PHR systems, OPD automation, and radiology AI for hospitals and healthcare providers. AlgoFlow AI reduced OPD wait times by 75% and prescription errors by 60%.',
	keywords: [
		'healthcare AI India',
		'ABDM integration',
		'ABHA health ID',
	...
	openGraph: {
		...
		description:
			'Clinical AI, ABDM M1/M2/M3 integration, PHR systems, and hospital management AI. 75% faster triage, 40% OPD reduction.',
