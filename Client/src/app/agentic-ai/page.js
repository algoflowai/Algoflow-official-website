...
const CAPABILITIES = [
	{
		...
		desc: 'Hierarchical agent networks where coordinator agents delegate to specialist sub-agents for complex enterprise workflows.',
	},
	{
		title: 'RAG-Powered Knowledge',
		desc: "Retrieval-Augmented Generation with private vector stores, keeping agents grounded in your company's data and policies.",
	},
	{
		title: 'Tool Use & API Calling',
		desc: 'Agents autonomously call REST APIs, query databases, use code interpreters, and integrate with ERP/CRM systems.',
	},
	{
		title: 'Human-in-the-Loop',
		desc: 'Configurable escalation paths — agents hand off to humans when confidence is low or stakes are high, with full audit trails.',
	},
	{
		title: 'Memory & Context',
		desc: 'Short-term (session) and long-term (vector DB) memory enable agents to learn from interactions and maintain context.',
	},
	{
		title: 'Security & Compliance',
		desc: 'Role-based access, PII masking, SOC 2 controls, GDPR-compliant data handling, and full audit logging baked in.',
	},
];
				...
				<div className="w-[90%] mx-auto py-24 lg:py-32 text-center relative z-10">
					...
					>
						...
						<span
							...
							style={{
								backgroundImage: 'linear-gradient(90deg,#8b5cf6,#a78bfa,#c4b5fd)',
							}}
						>
							Autonomously
						</span>
					...
					<motion.p
						className="text-lg text-gray-300 max-w-2xl mx-auto mt-6 leading-relaxed"
						initial={{ opacity: 0 }}
						animate={{ opacity: 1 }}
						transition={{ delay: 0.2 }}
					>
						Agentic AI systems that perceive context, reason through complexity, and
						take real actions — from banking transactions to hospital triage to factory
						floor management.
					</motion.p>
					<motion.div
			...
			<section className="w-[90%] mx-auto py-20">
				...
				>
					...
					<p className="text-gray-400 mt-3 max-w-xl mx-auto">
						A six-phase autonomous reasoning and action cycle that powers every AlgoFlow
						AI agent.
					</p>
				</motion.div>
					...
					{WORKFLOW.map((w, i) => (
						<motion.div
							...
							whileHover={{
								...
								background: `rgba(${w.color === '#3b82f6' ? '59,130,246' : w.color === '#8b5cf6' ? '139,92,246' : w.color === '#f59e0b' ? '245,158,11' : w.color === '#22c55e' ? '34,197,94' : w.color === '#14b8a6' ? '20,184,166' : '236,72,153'},0.06)`,
							}}
						>
							<div className="relative h-40 rounded-xl overflow-hidden mb-4">
								...
								<div
									...
									style={{
										background:
											'linear-gradient(to right, rgba(2,11,20,0.75) 0%, transparent 70%)',
									}}
								/>
								<span
			...
			>
				<div className="w-[90%] mx-auto py-20">
					...
					>
						...
						<p className="text-gray-400 mt-3 max-w-xl mx-auto">
							Purpose-built agentic systems for the industries where speed, accuracy,
							...
							>
								<div className="relative h-40 rounded-xl overflow-hidden">
									...
									<div
										...
										style={{
											background:
												'linear-gradient(to top, rgba(2,11,20,0.65) 0%, transparent 60%)',
										}}
									/>
									<span
			...
			<section className="w-[90%] mx-auto py-20">
				...
				>
					...
					<p className="text-gray-400 mt-3">
						Enterprise-grade infrastructure powering every agent we build.
					</p>
				</motion.div>
					...
					<div className="grid md:grid-cols-3 gap-6">
						{CASE_STUDIES.map((cs, i) => (
							...
							>
								...
								<div
									className="text-2xl font-extrabold text-transparent bg-clip-text mb-3"
									style={{
			...
			<section className="max-w-4xl mx-auto px-6 py-24 text-center">
				...
				>
					...
					<p className="text-gray-400 mb-8 max-w-xl mx-auto">
						We design, build, and operate production-grade agentic systems. From
						proof-of-concept in 2 weeks to full enterprise rollout.
					</p>
